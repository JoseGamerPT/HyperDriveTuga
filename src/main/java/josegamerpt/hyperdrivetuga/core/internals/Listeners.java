...
import josegamerpt.hyperdrivetuga.api.events.MenuOpenEvent;
import josegamerpt.hyperdrivetuga.api.events.RandomTeleportEvent;
...
public class Listeners implements Listener {
    ...
    public Listeners(HyperDriveTuga pluginInstance) {
